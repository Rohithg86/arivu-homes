  ...
  return (
    <>
      ...
      <div className="fixed bottom-5 right-5 z-50 flex flex-col gap-3 items-end">
        <a
          href="https://www.instagram.com/arivuhomes/"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center rounded-full bg-gradient-to-tr from-yellow-400 via-red-500 to-purple-500 text-white shadow-lg w-14 h-14 hover:opacity-90 transition-all hover:scale-105"
